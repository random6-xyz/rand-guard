...
pub struct HealthRecord {
    ...
    pub userspace_invalid_schema: u64,
    pub userspace_unsupported_kind: u64,
    pub userspace_output_failures: u64,
    pub process_table_size: usize,
    pub pending_exec_source_size: usize,
    pub process_records_evicted: u64,
    pub pending_sources_evicted: u64,
    pub uptime_secs: u64,
...
pub fn format_health_json(record: &HealthRecord) -> String {
    serde_json::json!({
        ...
        "userspace_invalid_schema": record.userspace_invalid_schema,
        "userspace_unsupported_kind": record.userspace_unsupported_kind,
        "userspace_output_failures": record.userspace_output_failures,
        "process_table_size": record.process_table_size,
        "pending_exec_source_size": record.pending_exec_source_size,
        "process_records_evicted": record.process_records_evicted,
        "pending_sources_evicted": record.pending_sources_evicted,
